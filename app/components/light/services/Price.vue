      ...
      <div class="row">
        <div class="col-lg-5 valign">
          <div class="cont full-width md-mb50">
            <div>
              <h6 v-reveal class="sub-title main-color mb-15">
                How clients engage with us
              </h6>
              <h3 v-reveal:clip="{ delay: 80 }">
        ...
        <div class="col-lg-6 offset-lg-1 valign">
          <div class="full-width">
            <div v-reveal class="item sub-bg radius-10 d-flex align-items-center mb-30">
              <div class="type">
            ...
            <div v-reveal="{ delay: 120 }" class="item main-colorbg radius-10 text-dark d-flex align-items-center">
              <div class="type">
                ...
                <h5 class="fw-600">AI Transformation Roadmap</h5>
              </div>
              <div class="cont ml-50">
                <ul class="dot-list rest">
